...
\section{Applications and extensions}
	...
	\begin{frame}{Stateless ORAM}
		...
		\note{
			...
			This ways we can build a \emph{stateless} ORAM --- potentially, multi-user ORAM\@.
		}
	\end{frame}
	...
	\begin{frame}{Integrity}
		...
		\note{
			...
			Each node is tagged with the hash of the following form, which is a concatenation of hashes of all blocks in the bucket, and left and right child of the node.
		}
	\end{frame}
