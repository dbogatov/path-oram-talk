\section{Bounds on stash usage}
	...
	\begin{frame}{Probability of failure is negligible}
		...
		\note{
			...
			It might look complex, but simply put, what is says is that for any ORAM with 5 blocks per bucket, stash usage exceeds some stash size $R$ with probability at most exponentially small with respect ot $R$.
	...
	\begin{frame}{Probability of failure is negligible}
		...
		\note{
			...
			Finally, they show how a mixture of a binomial and a geometric probability distribution expresses the probability of the number of real blocks that do not get evicted from a subtree after a sequence of load/store operations.
		}
	\end{frame}
